...
2. Backward Elimination (Step wise regression) (1) Select SL $\alpha$. Normally $\alpha$ = 0.05, (2) Fit model with all the predictors $X_i$, (3) Select predictor for which $p_i$ > $\alpha$
